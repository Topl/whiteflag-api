...
function startServer(callback) {
    ...
    // Middleware -- enable CORS only for ODYSSEY hackaton
    _wfApi.use(cors());
    log.info(MODULELOG, 'ODYSSEY -- Enabled HTTP (CORS)');
...
function createEndpoints(endpointCb, callback) {
    ...
    try {
        ...
        log.trace(MODULELOG, 'Creating endpoint for all undefined routs and methods');
